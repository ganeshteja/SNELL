...
static void BN254::PAIR_double(ECP2 *A, FP2 *AA, FP2 *BB, FP2 *CC)
{
    FP2 YY;
...
static void BN254::PAIR_add(ECP2 *A, ECP2 *B, FP2 *AA, FP2 *BB, FP2 *CC)
{
    FP2 T1;
...
/* Line function */
static void BN254::PAIR_line(FP12 *v, ECP2 *A, ECP2 *B, FP *Qx, FP *Qy)
{
    FP2 AA, BB, CC;
    FP4 a, b, c;
...
int BN254::PAIR_nbits(BIG n3, BIG n)
{
    BIG x;
...
/* basic Miller loop */
void BN254::PAIR_miller(FP12 *res, FP12 r[])
{
    int i;
    FP12_one(res);
...
static void BN254::PAIR_pack(FP4 *T, FP2* AA, FP2* BB, FP2 *CC)
{
    FP2 I, A, B;
    FP2_inv(&I, CC, NULL);
    FP2_mul(&A, AA, &I);
...
static void BN254::PAIR_unpack(FP12 *v, FP4* T, FP *Qx, FP *Qy)
{
    FP4 a, b, c;
    FP2 t;
    FP4_copy(&a, T);
...
void BN254::PAIR_precomp(FP4 T[], ECP2* GV)
{
    int i, j, nb, bt;
    BIG n, n3;
    FP2 AA, BB, CC;
...
void BN254::PAIR_another_pc(FP12 r[], FP4 T[], ECP *QV)
{
    int i, j, nb, bt;
    BIG n, n3;
    FP12 lv, lv2;
...
void BN254::PAIR_another(FP12 r[], ECP2* PV, ECP* QV)
{
    int i, nb, bt;
    BIG n, n3;
    FP12 lv, lv2;
...
void BN254::PAIR_ate(FP12 *r, ECP2 *P1, ECP *Q1)
{
    BIG n, n3;
    FP Qx, Qy;
    int i, nb, bt;
...
void BN254::PAIR_double_ate(FP12 *r, ECP2 *P1, ECP *Q1, ECP2 *R1, ECP *S1)
{
...
#ifdef USE_GLV_BN254
/* GLV method */
static void BN254::glv(BIG u[2], BIG ee)
{
    BIG q;
...
static void BN254::gs(BIG u[4], BIG ee)
{
    int i;
    BIG q;
    BIG_rcopy(q, CURVE_Order);
...
void BN254::PAIR_G1mul(ECP *P, BIG e)
{
    BIG ee,q;
    BIG_copy(ee,e);
    BIG_rcopy(q, CURVE_Order);
...
void BN254::PAIR_G2mul(ECP2 *P, BIG e)
{
    BIG ee,q;
    BIG_copy(ee,e);
    BIG_rcopy(q, CURVE_Order);
...
/* f=f^e */
void BN254::PAIR_GTpow(FP12 *f, BIG e)
{
    BIG ee,q;
    BIG_copy(ee,e);
    BIG_rcopy(q, CURVE_Order);
...
int BN254::PAIR_G2member(ECP2 *P)
{
    ECP2 W,T;
    BIG x;
    FP2 X;
...
int BN254::PAIR_GTcyclotomic(FP12 *m)
{
	FP fx,fy;
	FP2 X;
	FP12 r,w;
...
int BN254::PAIR_GTmember(FP12 *m)
{
    BIG x;
    FP2 X;
    FP fx, fy;
