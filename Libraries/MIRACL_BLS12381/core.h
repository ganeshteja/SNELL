...
#define GENERALISED_MERSENNE 2 /**< Generalised-mersenne modulus of form $2^n-2^m-1$, Ed448 only */
...
#define FP_ZILCH 0			// 0
#define FP_UNITY 1			// 1
#define FP_SPARSEST 2		// [[AB][c0][00]]
#define FP_SPARSER 3		// [[AB][C0][00]]
#define FP_SPARSE 4			// [[AB][CD][E0]]
#define FP_DENSE 5			// [[AB][CD][EF]]
