...
//    int inf; /**< Infinity Flag */
    BLS12381::FP2 x;   /**< x-coordinate of point */
    BLS12381::FP2 y;   /**< y-coordinate of point */
    BLS12381::FP2 z;   /**< z-coordinate of point */
} ECP2;
 ...
 */
extern int ECP2_get(BLS12381::FP2 *x, BLS12381::FP2 *y, ECP2 *P);
 ...
 */
extern void ECP2_rhs(BLS12381::FP2 *r, BLS12381::FP2 *x);
 ...
 */
extern int ECP2_set(ECP2 *P, BLS12381::FP2 *x, BLS12381::FP2 *y);
 ...
 *
	...
	@return 1 if point exists, else 0
 */
extern int ECP2_setx(ECP2 *P, BLS12381::FP2 *x, int s);
 ...
 */
extern void ECP2_frob(ECP2 *P, BLS12381::FP2 *f);
 ...
 */
extern void ECP2_map2point(ECP2 *Q, BLS12381::FP2 *x);
